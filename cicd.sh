...
echo "${GREEN}##########################################################################################${NC}\n\n\n"
  ...
  docker build -t quay.io/appdev_playground/3scale-demo:service-a-$VERSION -f services/service-a/metadata/Dockerfile services/service-a --platform linux/amd64
  docker push quay.io/appdev_playground/3scale-demo:service-a-$VERSION
...
echo "${GREEN}##########################################################################################${NC}\n\n\n"
  ...
  docker build -t quay.io/appdev_playground/3scale-demo:service-a-v2-$VERSION -f services/service-a-v2/metadata/Dockerfile services/service-a-v2 --platform linux/amd64
  docker push quay.io/appdev_playground/3scale-demo:service-a-v2-$VERSION
...
echo "${GREEN}##########################################################################################${NC}\n\n\n"
  ...
  echo "${GREEN}##########################################################################################${NC}\n\n\n"
    ...
    docker build -t quay.io/appdev_playground/3scale-demo:service-b-$VERSION -f services/service-b/metadata/Dockerfile services/service-b --platform linux/amd64
    docker push quay.io/appdev_playground/3scale-demo:service-b-$VERSION
  ...
  echo "${GREEN}##########################################################################################${NC}\n\n\n"
    ...
    docker build -t quay.io/appdev_playground/3scale-demo:service-c-$VERSION -f services/service-c/metadata/Dockerfile services/service-c --platform linux/amd64
    docker push quay.io/appdev_playground/3scale-demo:service-c-$VERSION
